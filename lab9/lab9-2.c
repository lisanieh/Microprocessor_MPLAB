...
void __interrupt(high_priority)H_ISR(){
    ...
    /*
     ...
     256 / 7 = 36.57 
    */
    if(value_h < 36){ //4 = 0100
        LATAbits.LATA1 = 0;
        LATAbits.LATA2 = 1;
        LATAbits.LATA3 = 0;
        LATAbits.LATA4 = 0;
    }
    else if(value_h >= 36 && value_h < 72){ //1 = 0001
        LATAbits.LATA1 = 0;
        LATAbits.LATA2 = 0;
        LATAbits.LATA3 = 0;
        LATAbits.LATA4 = 1;
    }
    else if(value_h >= 72 && value_h < 108){ //0 = 0000
        LATAbits.LATA1 = 0;
        LATAbits.LATA2 = 0;
        LATAbits.LATA3 = 0;
        LATAbits.LATA4 = 0;
    }
    else if(value_h >= 108 && value_h < 144){ //6 = 0110
        LATAbits.LATA1 = 0;
        LATAbits.LATA2 = 1;
        LATAbits.LATA3 = 1;
        LATAbits.LATA4 = 0;
    }
    else if(value_h >= 144 && value_h < 180){ //0 = 0000
        LATAbits.LATA1 = 0;
        LATAbits.LATA2 = 0;
        LATAbits.LATA3 = 0;
        LATAbits.LATA4 = 0;
    }
    else if(value_h >= 180 && value_h < 216){ //1 = 0001
        LATAbits.LATA1 = 0;
        LATAbits.LATA2 = 0;
        LATAbits.LATA3 = 0;
        LATAbits.LATA4 = 1;
